...
## Write clean fst                   
write_fst(fish, "Fish_All years.fst")
...
rm(fish, fish.2017_2022, fish.2018, fish.2019, fish.2020, fish.2021, fishRAW.2018, fishRAW.2019, fishRAW.2020, fishRAW.2021, meta.all,
   ...
   SurveyNo2025,
   surveys.tot, obs_block, raw_obs,  input_file, wb, fish_sizeclass, co, data_summary, biomass_sum, col_order, cols, i, idx_12, target_species)
...
```{r}
# Load data sets
fish <- read_fst("Fish_All years.fst")
