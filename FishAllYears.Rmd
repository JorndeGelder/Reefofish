...
Aplot2 <- ggplot(emm_diet_df, aes(x = DietH, y = response*100, shape = YearGroup, group = YearGroup)) +
...
Aplot3 <- ggplot(emm_patch_df, aes(x = Patch.type, y = response*100, shape = YearGroup, group = YearGroup)) +
  geom_point(position = position_dodge(width = 0.5), size = 3) +
  geom_errorbar(aes(ymin = asymp.LCL*100, ymax = asymp.UCL*100),
                position = position_dodge(width = 0.5),
                width = 0.2) +
  geom_text(aes(label = .group, y = asymp.UCL*100),
            ...
            size = 4.5,
            show.legend = FALSE) +
  labs(x = "Reef design", y = expression(Abundance ~ (m^-2 ~ x ~ 100)),
...
MSplot2 <- ggplot(emm2_df, aes(x = DietH, y = response, shape = YearGroup, group = YearGroup)) +
  geom_point(position = position_dodge(width = 0.5), size = 3) +
...
# Plot 2: Yeargroup x DietH interaction
Bplot2 <- ggplot(emm_diet_df, aes(x = DietH, y = response, shape = YearGroup, group = YearGroup)) +
  geom_point(position = position_dodge(width = 0.5), size = 3) +
  geom_errorbar(aes(ymin = asymp.LCL, ymax = asymp.UCL),
                position = position_dodge(width = 0.5),
                width = 0.2) +
...
# Plot 2: Yeargroup x DietH interaction
Rplot2 <- ggplot(emm_diet_df, aes(x = DietH, y = response, shape = YearGroup, group = YearGroup)) +
  geom_point(position = position_dodge(width = 0.5), size = 3) +
  geom_errorbar(aes(ymin = asymp.LCL, ymax = asymp.UCL),
                position = position_dodge(width = 0.5),
                width = 0.2) +
...
# Plot 3: Yeargroup x patch.type interaction
Rplot3 <- ggplot(emm_patch_df, aes(x = Patch.type, y = response, shape = YearGroup, group = YearGroup)) +
  geom_point(position = position_dodge(width = 0.5), size = 3) +
  geom_errorbar(aes(ymin = asymp.LCL, ymax = asymp.UCL),
                position = position_dodge(width = 0.5),
                width = 0.2) +
...
top10_species$font_size <- scales::rescale(top10_species$Biomass, to = c(3, 4))

top10_species$NMDS1[top10_species$Species == "Hipposcarus harid"] <- 0.15
top10_species$NMDS2[top10_species$Species == "Hipposcarus harid"] <- 0.06
...
# final_plot2
```
## Inset plot for Patch.type without dots
```{r}
# Start from full data and null out the outliers only for ellipse grouping
data_ell <- site.scores
...
main_plot
```
## Inset plot for YearGroup without dots
```{r}
data_ell <- site.scores
...
for(p in plots){
  ...
  # Save EMF
  ggsave(
    filename = file.path("C:/Users/jornd/OneDrive - Wageningen University & Research/Thesis/Plots/Noncombined_emf", paste0(p, ".emf")),
    plot     = plot_obj,
    device   = "emf",
    width    = 7,
    height   = 5
...
## Save EMF
ggsave(
    filename = file.path("C:/Users/jornd/OneDrive - Wageningen University & Research/Thesis/Plots/plots_emf", paste0("MSplot5.emf")),
    plot     = MSplot5,
    device   = "emf",
    width    = 7,
    height   = 12
...
## EMF
emf(file.path("C:/Users/jornd/OneDrive - Wageningen University & Research/Thesis/Plots/plots_emf", "nMDSplot1.emf"),
    width = 7, height = 5)
print(main_plot)
dev.off()
...
## EMF
emf(file.path("C:/Users/jornd/OneDrive - Wageningen University & Research/Thesis/Plots/plots_emf", "nMDSplot2.emf"),
    width = 7, height = 5)
print(main_plot2)
dev.off()
...
ggsave(file.path("C:/Users/jornd/OneDrive - Wageningen University & Research/Thesis/Plots/plots_emf", "Combined_time_guild.emf"), 
...
ggsave(file.path("C:/Users/jornd/OneDrive - Wageningen University & Research/Thesis/Plots/plots_emf", "Combined_time_patch.emf"), 
...
ggsave(file.path("C:/Users/jornd/OneDrive - Wageningen University & Research/Thesis/Plots/plots_emf", "Combined_richness.emf"), 
